...
public class PendingAccommodationWhole {
...
//    protected List<SeasonalRate> seasonalRates;
    ...
    public PendingAccommodationWhole() {
    }

    public PendingAccommodationWhole(Long id, Long accommodationId, String name, String description, String location, List<String> amenities, List<Long> images, int minGuests, int maxGuests, String type, double price, boolean isPricePerGuest, String city, String country, String street, int number, int deadline, boolean isAutomatic, String hostUsername) {
        this.id = id;
    ...
    public String toString() {
        return "PendingAccommodationWhole{" +
                "id=" + id +
